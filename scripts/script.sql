...
CREATE TABLE public."Management" (
	...
	CONSTRAINT "FK_Management_Property_Id" FOREIGN KEY ("property_id") REFERENCES public."Property"("id") ON DELETE RESTRICT	
);		

CREATE INDEX "IX_Management_Property_Id" ON public."Management" USING btree ("property_id");
